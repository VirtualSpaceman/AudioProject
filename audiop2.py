...
class GaussianMixtureModel(Model):
    ...
    def enroll_speakers(self, data):
        ...
        for name, list_features in data.items():
    ...
    def save(self, filename):
        ...
        bob.bio.base.save(self.model, f)
        self.model.save(f)
        f.cd('/')
...
if __name__ == "__main__":
    ...
    # from FeaturesManager import FeaturesManager
    #
    # timit = TimitManager.load('/home/levy/SpeakerRecognition/timit_manager.pickle')
    # features_path = '/home/levy/features1'
    ...
    gmm_model = GaussianMixtureModel(512, kmeans_iterations=50, gmm_iterations=50, gmm_enrollment_iterations=50)
    gmm_model.train_model(data_ubm)
    gmm_model.enroll_speakers(data_speakers)
    gmm_model.calculate_scores(data_verification)
    gmm_model.save('model')
